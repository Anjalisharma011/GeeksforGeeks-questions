<h2><a href="https://www.geeksforgeeks.org/problems/c-2-d-arrays0708/1?page=2&difficulty=Basic&sortBy=difficulty">C++ 2-D Arrays | Set-1</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a 2-d array of integers having&nbsp;<strong>N*N&nbsp;</strong>elements, print the transpose of the array.</span></p>
